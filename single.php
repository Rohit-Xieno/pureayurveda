...
<article>
  ...
  <div class="social-post-sidebar flex items-center mt-12"><?php dynamic_sidebar('social-share-sidebar'); ?></div>
  <div class="about-author border-b border-[#c8c8c8] py-5 mb-8">
    <h3 class="text-[22px] text-[#96225d]">About Author</h3>
    <?php echo wpautop(get_the_author_meta('description')); ?>
  </div>
  <div id="single_post_wrap"><?php comment_form(); ?>
    
  </div>
  </div>
  <div class="single-post-sidebar w-[40%]"><?php dynamic_sidebar('sidebar'); ?>
